...
pub static GLOBAL_TYPE_MEMBERS: LazyLock<Vec<TypeMember>> = LazyLock::new(|| {
    (0..NUM_PREDEFINED_TYPES)
        .map(TypeId::new)
        .map(|id| TypeMember {
            kind: TypeMemberKind::Named(Text::const_new(global_type_name(id))),
...
impl Default for GlobalsResolver {
    fn default() -> Self {
            ...
            |id: TypeId,
             ...
             type_parameters: Box<[TypeReference]>| {
                TypeData::from(Function {
                    is_async: false,
                    type_parameters,
                    name: Some(Text::const_new(global_type_name(id))),
        ...
        let string_literal = |value: &'static str| -> TypeData {
            TypeData::from(Literal::String(Text::const_new(value).into()))
        };
        ...
        let types = vec![
            ...
            TypeData::Class(Box::new(Class {
                name: Some(Text::const_new("Array")),
                ...
                members: Box::new([
                    ...
                    TypeMember {
                        kind: TypeMemberKind::Named(Text::const_new("length")),
            ...
            TypeData::Class(Box::new(Class {
                name: Some(Text::const_new("Promise")),
                type_parameters: Box::new([TypeReference::from(GLOBAL_T_ID)]),
                extends: None,
                implements: [].into(),
                members: Box::new([
            ...
            TypeData::from(Function {
                is_async: false,
                type_parameters: Default::default(),
                name: Some(Text::const_new(global_type_name(PROMISE_CONSTRUCTOR_ID))),
                parameters: [FunctionParameter::Pattern(PatternFunctionParameter {
                    bindings: Default::default(),
                    is_optional: false,
                    is_rest: false,
            ...
            TypeData::from(Function {
                is_async: false,
                type_parameters: Default::default(),
                name: Some(Text::const_new(global_type_name(CONDITIONAL_CALLBACK_ID))),
                parameters: Default::default(),
            ...
            TypeData::from(Function {
                is_async: false,
                type_parameters: Default::default(),
                name: Some(Text::const_new(global_type_name(MAP_CALLBACK_ID))),
                parameters: [FunctionParameter::Pattern(PatternFunctionParameter {
                    ty: GLOBAL_U_ID.into(),
                    bindings: Default::default(),
                    is_optional: false,
            ...
            TypeData::from(Function {
                is_async: false,
                type_parameters: Default::default(),
                name: Some(Text::const_new(global_type_name(VOID_CALLBACK_ID))),
                parameters: Default::default(),
                return_type: ReturnType::Type(GLOBAL_VOID_ID.into()),
            }),
            TypeData::from(Function {
                is_async: false,
                type_parameters: Default::default(),
                name: Some(Text::const_new(global_type_name(FETCH_ID))),
                parameters: Default::default(),
                return_type: ReturnType::Type(GLOBAL_INSTANCEOF_PROMISE_ID.into()),
            }),
        ];
